...
int main() {
    ...
    long_number num1 = 10.0_longnum;
    long_number num2 = 5.0_longnum;

    long_number sum = num1 + num2;
    long_number diff = num1 - num2;
    long_number prod = num1 * num2;
    long_number div = num1 / num2;
